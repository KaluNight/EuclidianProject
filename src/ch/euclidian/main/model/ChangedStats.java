    ...
    switch(type) {
      ...
      case DURATION:
        ...
        if((int) oldValue < (int) newValue) {
          return "La durée moyenne de vos parties à augmentée de " + oldMinutes + " min. " + oldSecondes + " s. à " + newMinutes + " min. "
              + newSecondes + " s.";
        } else if((int) oldValue > (int) newValue) {
          return "La durée moyenne de vos parties à été réduite de " + newMinutes + " min. " + newSecondes + " s. à " + oldMinutes
              + " min. " + oldSecondes + " s.";
        } else {
      ...
      case CREEP_AT_10:
        ...
        if((double) oldValue < (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) newValue - (double) oldValue))
              + " creeps à 10 minutes de plus que la dernière fois.\n" + "Semaine passé : " + doubleFormater.format((double) oldValue)
              + " creeps à 10 minutes en moyenne.\n" + "Cette semaine : " + doubleFormater.format((double) newValue)
              + " creeps à 10 minutes en moyenne.";
          ...
          return "Vous avez en moyenne " + ((double) oldValue - (double) newValue) + " creeps à 10 minutes de moins que la dernière fois.\n"
              ...
              + doubleFormater.format((double) newValue) + " creeps à 10 minutes en moyenne.";
        } else {
      ...
      case CREEP_AT_20:
        ...
        if((double) oldValue < (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) newValue - (double) oldValue))
              + " creeps à 20 minutes de plus que la dernière fois.\n" + "Semaine passé : " + doubleFormater.format((double) oldValue)
              + " creeps à 20 minutes en moyenne.\n" + "Cette semaine : " + doubleFormater.format((double) newValue)
              + " creeps à 20 minutes en moyenne.";
        } else if((double) oldValue > (double) newValue) {
          return "Vous avez en moyenne " + ((double) oldValue - (double) newValue) + " creeps à 20 minutes de moins que la dernière fois.\n"
              ...
              + doubleFormater.format((double) newValue) + " creeps à 20 minutes en moyenne.";
        } else {
      ...
      case CREEP_AT_30:
        ...
        if((double) oldValue < (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) newValue - (double) oldValue))
              + " creeps à 30 minutes de plus que la dernière fois.\n" + "Semaine passé : " + doubleFormater.format((double) oldValue)
              + " creeps à 30 minutes en moyenne.\n" + "Cette semaine : " + doubleFormater.format((double) newValue)
              + " creeps à 30 minutes en moyenne.";
        } else if((double) oldValue > (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) oldValue - (double) newValue))
              + " creeps à 30 minutes de moins que la dernière fois.\n" + "Semaine passé : " + doubleFormater.format((double) oldValue)
              + " creeps à 30 minutes en moyenne.\n" + "Cette semaine : " + doubleFormater.format((double) newValue)
              + " creeps à 30 minutes en moyenne.";
        } else {
      ...
      case KDA:
        ...
        if((double) oldValue < (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) newValue - (double) oldValue))
              + " de KDA moyen supplémentaires par rapport à la dernière fois.\n" + "Semaine passé : "
              + doubleFormater.format((double) oldValue) + " de KDA moyen\n" + "Cette semaine : " + doubleFormater.format((double) newValue)
              + " de KDA moyen";
        } else if((double) oldValue > (double) newValue) {
          return "Vous avez en moyenne " + doubleFormater.format(((double) oldValue - (double) newValue))
              + " de KDA moyen en moins par rapport à la dernière fois.\n" + "Semaine passé : " + doubleFormater.format((double) oldValue)
              + " de KDA moyen.\n" + "Cette semaine : " + doubleFormater.format((double) newValue) + " de KDA moyen.";
        } else {
          return "Vous avez en moyenne un KDA moyen égale à la dernière fois.\n" + "KDA moyen cette semaine : "
              + doubleFormater.format((double) newValue);
        }
